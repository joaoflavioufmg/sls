...
# ##################################################################
# Uma central telefônica recebe chamadas a intervalos aleatórios 
...
def chegada (env, entidade, troncos):
    ...
    while True:        
        ...
        if troncos.count < CAP_TRONCOS:            
            ...
            # print("%.1f Chamada %2i perdida!\t Numeros Perdidos: %2i" % (env.now, conta_chegada, conta_perdida))
            conta_perdida+=1
            conta_saida+=1
...
def atendimento (env, nome, troncos):
    ...
    # Fila de entidades aguardando o uso do recurso.
    # if env.now > tempo_aquecimento:
    ...
    # print("{0:.2f}: Servidor inicia o atendimento da {1:s}. Número de entidades em atendimento: {2:d}".format(env.now, nome, troncos.count))
    # if env.now > tempo_aquecimento:
    ...
    # print("{0:.2f}: Servidor termina o atendimento da {1:s}. Número de entidades em fila: {2:d}".format(env.now, nome, len(troncos.queue))) 
    ...
    # print('conta_chegada: ', conta_chegada)
    # print('conta_saida: ', conta_saida)
    # print('numero_sistema: ', numero_sistema)
    if env.now > tempo_aquecimento:
...
def publica_estatisticas():  
    ...
    if n_replicacoes == 1:
        ...
        plt.plot(xi, y, marker='o', linestyle='-', color='b', label='Dados')
        plt.ylim(0.0,1.0)
