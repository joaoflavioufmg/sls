...
Aux_adm_of = simpy.Resource(env, capacity=2)
Aux_adm_reg = simpy.Resource(env, capacity=2)
Aux_almox = simpy.Resource(env, capacity=2)
Aux_far_frac = simpy.Resource(env, capacity=4)
Aux_far_unita_manual = simpy.Resource(env, capacity=2)
Aux_far_unita_auto = simpy.Resource(env, capacity=2)
Aux_far_estoq_interno = simpy.Resource(env, capacity=4)
Aux_dispensacao_satelite = simpy.Resource(env, capacity=2)
